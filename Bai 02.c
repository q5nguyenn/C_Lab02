...
float f = 25.3; // Kieu du lieu so thuc float co mien rong hon , chinh xac hon float, co the co 10 con so phan thap phan
double d = 25.3; // Kieu du lieu so thuc double co mien gia tri rat lon so voi float
